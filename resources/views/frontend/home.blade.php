    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
                ...
                <div class="text-gray-600">Golf Courses</div>
            </div>
            <div>
                <div class="text-4xl font-bold text-green-600 mb-2">{{ $stats['total_tours'] }}+</div>
                <div class="text-gray-600">Golf Tours</div>
            </div>
            <div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    <div class="flex items-center justify-between mb-8">
        <h2 class="text-3xl font-bold text-gray-900">Featured Golf Courses</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        @foreach($featuredCourses as $course)
            <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-all transform hover:-translate-y-1">
                <div class="relative">
                    <img 
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-semibold text-gray-700">{{ number_format($course->rating, 1) }}</span>
                        </div>
                    </div>
...
<div class="bg-gray-100 py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between mb-8">
            <h2 class="text-3xl font-bold text-gray-900">Featured Golf Tours</h2>
                    ...
                    <div class="md:flex">
                        ...
                        <div class="p-6 flex-1">
                            <div class="flex items-center mb-2">
                                ...
                                <span class="ml-2 text-sm text-gray-500">{{ $tour->rounds_of_golf }} Rounds</span>
                            </div>
                            <h3 class="text-xl font-bold text-gray-900 mb-2">{{ $tour->name }}</h3>
                            <p class="text-gray-600 text-sm mb-3 line-clamp-2">{{ Str::limit($tour->description, 120) }}</p>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="text-center">
            ...
            <p class="text-gray-600">Competitive rates and exclusive deals on premium golf courses</p>
        </div>
        <div class="text-center">
            <div class="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg class="w-8 h-8 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p class="text-gray-600">Real-time availability and instant confirmation</p>
        </div>
        <div class="text-center">
            <div class="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg class="w-8 h-8 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p class="text-gray-600">Dedicated customer support whenever you need it</p>
        </div>
    </div>
</div>
