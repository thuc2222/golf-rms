    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            @if($vendor->golfCourses->count() > 0)
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <h2 class="text-2xl font-bold text-gray-900 mb-6">Our Golf Courses</h2>
            ...
            @if($vendor->golfTours->count() > 0)
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <h2 class="text-2xl font-bold text-gray-900 mb-6">Our Golf Tours</h2>
                    <div class="space-y-4">
                            ...
                            <div class="border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
                                <div class="md:flex">
                                    ...
                                    <div class="p-4 flex-1">
                                        ...
                                        <p class="text-sm text-gray-600 mb-3 line-clamp-2">{{ Str::limit($tour->description, 120) }}</p>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-lg shadow-lg p-6 sticky top-20">
                ...
                <div class="space-y-4 mb-6">
                    @if($vendor->email)
                        <div class="flex items-start">
                            ...
                            <a href="mailto:{{ $vendor->email }}" class="text-gray-700 hover:text-purple-600">
                                {{ $vendor->email }}
                            </a>
                        </div>
                    @endif
                    ...
                    @if($vendor->phone)
                        <div class="flex items-start">
                            ...
                            <a href="tel:{{ $vendor->phone }}" class="text-gray-700 hover:text-purple-600">
                                {{ $vendor->phone }}
                            </a>
                        </div>
                    @endif
                    ...
                    @if($vendor->website)
                        <div class="flex items-start">
                            ...
                            <a href="{{ $vendor->website }}" target="_blank" rel="noopener noreferrer" class="text-gray-700 hover:text-purple-600">
                                Visit Website
                            </a>
                        </div>
                    @endif
                ...
                <div class="border-t border-gray-200 pt-6 mt-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="text-center bg-gray-50 p-4 rounded-lg">
                            ...
                            <div class="text-sm text-gray-600 mt-1">Tours</div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Trust Badges -->
                <div class="border-t border-gray-200 pt-6 mt-6">
                    <h4 class="font-semibold text-gray-900 mb-4">Trust & Safety</h4>
