    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div class="text-center">
                        ...
                        <div class="text-sm text-gray-600">Holes</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-green-600">{{ $course->par }}</div>
                        <div class="text-sm text-gray-600">Par</div>
                    </div>
                    <div class="text-center">
            ...
            @if($course->facilities || $course->amenities)
                <div class="bg-white rounded-lg shadow-lg p-6">
                    ...
                    @if($course->facilities)
                        <div class="mb-6">
                            <h3 class="font-semibold text-gray-900 mb-3">Facilities</h3>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="text-2xl font-bold text-gray-900">Course Map</h2>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-lg shadow-lg p-6 sticky top-20">
                <h3 class="text-xl font-bold text-gray-900 mb-4">Book a Tee Time</h3>
                ...
                <div class="border-t border-gray-200 pt-4 mt-4">
                    <h4 class="font-semibold text-gray-900 mb-3">Managed By</h4>
                    <div class="flex items-center">
                        ...
                        @endif
                        <div>
                            <div class="font-semibold text-gray-900">{{ $course->vendor->business_name }}</div>
                    ...
                    <div class="space-y-4">
                        @foreach($similarCourses as $similar)
                            <div class="flex space-x-3">
                                ...
                                >
                                <div class="flex-1">
                                    <h4 class="font-semibold text-gray-900 text-sm mb-1">{{ $similar->name }}</h4>
