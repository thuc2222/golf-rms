    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($tours as $tour)
            <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-all transform hover:-translate-y-1">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 text-sm mb-4 line-clamp-2">{{ Str::limit($tour->description, 100) }}</p>
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-semibold text-gray-700">{{ number_format($tour->rating, 1) }}</span>
                        </div>
                    </div>
                    <a 
        ...
        @empty
            <div class="col-span-full text-center py-12">
                <p class="text-gray-500 text-lg">No tours found matching your criteria.</p>
            </div>
        @endforelse
    </div>
